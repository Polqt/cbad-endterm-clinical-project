<div id="sidebar" class="d-flex flex-column p-3 text-bg-dark min-vh-100">
    <a href="<?= urlIs('') ?>" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">

    </a>
    <hr>
    <ul class="nav nav-pills flex-column mb-auto gap-4 my-4">
        <li>
            <a href="<?= urlIs('') ?>" class="nav-link text-white d-flex align-items-center gap-3">
